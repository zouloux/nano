...
class NanoDebug
{
	...
	static public function profileStop ( string $name ) {
		...
		if ( !isset(self::$__profiles[ $name ]) ) return null;
	...
	static public function render () {
		...
		NanoDebug::profileStop("App");
		NanoDebug::profileStop("Responder");
		// Init var dumper as string output
		NanoDebug::$__dumper = new HtmlDumper();
		NanoDebug::$__cloner = new VarCloner();
		...
		$renderedHTML .= self::tabContent( self::dumpToString(Nano::$renderer->getThemeVariables()) );
		$dumbBuffer = '';
